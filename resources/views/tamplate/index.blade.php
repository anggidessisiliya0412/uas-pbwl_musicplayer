...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html">Music Player </a>
        ...
        <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2020 Anggi Dessisiliya-UAS </b>Pem.Web Lanjutan.
            </div>
        </div>
